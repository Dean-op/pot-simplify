            ...
            >
                ...
                <div className='config-item'>
                    ...
                    <Button
                        ...
                        color='primary'
                        onPress={() => {
                            open('https://fanyi-api.baidu.com/');
                        }}
                    >
                        {t('services.translate.baidu.apply_free_key')}
                    </Button>
                </div>
                <div className='my-2 px-1 text-xs text-default-500'>
                    {t('services.translate.baidu.description')}
                </div>
                <div className='config-item'>
                    <Input
