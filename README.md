...
| **翻译服务** | 21 个内置服务 + 外部插件 | 精选 7 个核心服务：国内直连免翻墙（有道/百度）、谷歌、大模型及权威词典 |
...
### 1. 划词与输入翻译
- **国内免翻墙直连翻译**：
  - **有道翻译（默认主力）**：接入国内高速通道，**默认免配置开箱即用（无需任何 API Key，无需翻墙）**，实测延迟约 100ms，完美支持长句与段落互译；同时支持可选配置个人有道智云 AppKey/Secret。
  - **百度翻译**：对接百度翻译开放平台官方接口，支持个人免费额度（每月 5 万 ~ 100 万字符免费），使用纯 JS 轻量签名，稳定可靠。
